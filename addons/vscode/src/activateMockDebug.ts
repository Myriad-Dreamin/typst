...
import { TypstDebugSession } from "./mockDebug";
import { FileAccessor } from "./mockRuntime";
import { DEBUGGER_TYPE as TYPST_DEBUGGER_TYPE } from "./consts";
...
export function activateMockDebug(
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand(
      "myriaddreamin.typst-debugger.getProgramName",
      (config) => {
        return vscode.window.showInputBox({
          placeHolder:
            "Please enter the name of a typst file in the workspace folder",
          value: "test.typ",
        });
      }
    )
